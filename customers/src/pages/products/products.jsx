...
          bookPublisher: publisherParam || selectedPublishers.join(","),
          bookSupplier: supplierParam || selectedSuppliers.join(","),
...
            `http://localhost:8081/api/author/${encodeURIComponent(
              authorToFetch
            )}`
          );
...
                <ul className="list-disc ml-4">
                  {Object.entries(authorDetails.externalLinks).map(
                    ([key, value]) => (
                      <li key={key}>
                        <a
                          href={value}
