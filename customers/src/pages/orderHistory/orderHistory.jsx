...
const OrderHistory = () => {
  ...
  return (
    <div className="p-5 max-w-6xl mx-auto bg-gray-100 rounded-md shadow-md">
      {/* Filter */}
      <div className="flex justify-center gap-3 mb-5">
        {["Chờ xử lý", "Đã nhận đơn", "Đang giao hàng", "Đã giao", "Đã nhận hàng", "Đã yêu cầu hủy", "Đã hủy"].map((status) => (
          <button
            ...
            className={`px-4 py-2 !rounded-xl font-semibold transition flex-grow text-center whitespace-nowrap ${
              filter === status
