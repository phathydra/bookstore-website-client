          ...
          <Box display="flex" mb={3} p={2} sx={{ border: '1px solid #ddd', borderRadius: '8px' }}>
            <Box sx={{ width: '35%', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
              <img
                ...
                style={{ width: '320px', height: '320px', objectFit: 'cover', borderRadius: '4px' }}
              />
              <Typography variant="h5" sx={{ fontWeight: 'bold', textAlign: 'center', marginTop: 2, width: '100%' }}>
                {selectedBook.bookName}
              </Typography>
              <Box sx={{ width: '100%', display: 'flex', justifyContent: 'flex-start', ml: 2 }}>
