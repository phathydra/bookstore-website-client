    ...
    return (
        <div className="flex h-screen">
            ...
            <div className="flex-1 flex flex-col transition-all duration-300" style={{ marginLeft: isCollapsed ? '5rem' : '16.666667%' }}>
                <Header title="Hồ sơ người dùng" isCollapsed={isCollapsed} />
                <div className="flex justify-center p-6 pr-10">
                    <div className="mt-20 bg-white shadow-lg rounded-lg p-6 w-4/5">
                        <h2 className="text-xl font-semibold text-center mb-4">Hồ sơ người dùng</h2>
